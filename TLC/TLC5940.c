...
//#define GSCLK GPIO_Pin_0 //will be done from SPI2_SCLK
...
void TLC5940_ClockInGS(void) {
	static uint16_t GSCLK_Counter = 0;
//  uint8_t firstCycleFlag = 0;
//
//  if (GPIO_ReadOutputDataBit(TLCPORT, VPRG)) {
...
void SPI_Config(void)
{
  ...
  SPI_InitStructure.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_256;// SPI_BaudRatePrescaler_2;
