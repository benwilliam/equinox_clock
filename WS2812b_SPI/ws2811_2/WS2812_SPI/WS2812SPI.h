 ...
 *
 */
class CWS2812SPI : public IWS2812Interface{
    public:
         /** \brief Init the WS2812 driver hardware and framebuffer
         *
         */
        virtual void ws2812_init(void);
    ...
    private:
         ...
         */
        const uint16_t WS2812_FRAMEBUF_LED_LEN = (NR_LEDS * BIT_FACTOR);

        /** \brief whole length of the framebuffer including dummy reset bytes
         */
        const uint16_t WS2812_FRAMEBUF_LEN = (WS2812_FRAMEBUF_LED_LEN + WS2812_RESET_LEN);
         ...
         *
         */
        uint8_t *pPixel = (uint8_t *) IWS2812Interface::Pixel;
