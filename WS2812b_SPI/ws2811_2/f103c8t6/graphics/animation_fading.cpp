...
CAnimationFading::CAnimationFading(IPixelDisplay *display, TIM_AnimationDriver *aniDriver, EFadingType fadingType)
    : IAnimation(display), aniDriver(aniDriver), fadingType(fadingType)
{
